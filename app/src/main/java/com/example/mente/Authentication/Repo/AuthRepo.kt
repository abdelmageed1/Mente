...
class AuthRepo() {
   ...
   // lateinit var user: User
    ...
    fun sendUserData(user: User) {
        ...
        {
            refUser.child(constant.userTypeSpecialist).child(auth.currentUser!!.uid).child("UserInfo").setValue(user)
        }
        else if (user.type == constant.userTypeParent)
        {
            refUser.child(constant.userTypeParent).child(auth.currentUser!!.uid).child("UserInfo").setValue(user)
